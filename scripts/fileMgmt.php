			...
			if ($_FILES["uploadFile"]["error"] > 0) {
	  		...
	  		switch($attachType) {
    				...
    				"../attachments/$attachType/$refNumber/" . $fileName))
    			{
	    			...
	    			$qryFileMngr1 = "INSERT INTO filemanager (name, size, fileType, location, refNumber, attachType, addedBy) VALUES
	    							('$fileDesc', '$fileSize', '$fileType', '$fileLocation', '$refNumber', '$attachType', '$_SESSION[uid]')";
