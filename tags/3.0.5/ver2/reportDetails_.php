...
if($_GET['status'] != 0)
{
	...
	if($dateFrom != ""){
	  $where[] = "(tblTickets.DateOpened >= '$dateFrom' OR tblTicketMessages.Date >= '$dateFrom') ";
	}
	...
	if($dateTo != "")
	{
		...
		$where[] = "(tblTickets.DateOpened <= '$dateTo' OR tblTicketMessages.Date <= '$dateTo') ";
	} 
}
else
{ 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center">
			...
			<a href="javascript:void(0)"onclick="window.open('<?php echo 'http://'. $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>&view=export','system','width=600,height=750,scrollbars=yes')"><font size="2" face="Arial">Export Results</font></a>
		</td>
	</tr>
	<?php
	}
