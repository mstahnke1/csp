...
<chart>
	<axis_category skip="0" font='arial' bold='true' size='12' color='000000' alpha='100' orientation='horizontal' />
	<axis_value min='0' max='4' steps='16' prefix='' suffix='' decimals='2' decimal_char='.' separator='' show_min='true' font='arial' bold='true' size='12' color='000000' alpha='75' orientation='horizontal' />
	<legend_label layout='horizontal' bullet='square' font='arial' bold='false' size='18' color='000000' alpha='100=' />
	<legend_rect x='135' y='390' width='700' height='50' margin='0' fill_color='000000' fill_alpha='7' line_color='000000' line_alpha='0' line_thickness='0' /> 		
	<chart_rect x='120' y='40' width='720' height='300' positive_color='ffffff' positive_alpha='50' negative_color='000000' negative_alpha='10' />
	<chart_data>
	      <row>
  	       <null/>
...
?>			
	...
	<draw>
		<text transition='dissolve' delay='0' duration='0.5' color='000000' alpha='100' font='Arial' rotation='0' bold='true' size='25' x='0' y='-48' width='925' height='75' h_align='center' v_align='bottom'>Customer Training Evaluation Statistics</text>
		<text color='000000' alpha='100' font='arial' rotation='-90' bold='true' size='20' x='50' y='350' width='300' height='150' h_align='center' v_align='top'>Avg Score</text>
	</draw>  
	<series_color>
		<color>8064A2</color>
		<color>9BBB59</color>
