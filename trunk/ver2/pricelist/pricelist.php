...
if(!((isset($_GET['PN'])) OR (isset($_GET['update'])) OR (isset($_GET['savechild'])) OR (isset($_GET['savenewpart'])) OR (isset($_GET['savefinal']))))
	{
...
<form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
	<table width = 750 border = 0>
		<tr>
			<td width = "95">
				<?php echo '<a href="' . 'pricelist.php'.'?update=add'.'">'?>ADD PART
			</td>
			<td>
	...
	<table width = 750 border = 1>		
		<tr>
			<td align = center colspan="2"><font size = 5 face = Arial><b>
				HOMEFREE PRICE LIST 2008
			</b></font></td>
		</tr>
		<tr>
			<td align = center bgcolor = 0000FF colspan="2"><font size = 4 face = Arial><b>
				SYSTEMS
			</b></font></td>
		</tr>
	</table>
...
if(isset($_GET['Save']))
	{
		...
		$array = array($ChildPart1,$ChildPart2,$ChildPart3,$ChildPart4,$ChildPart5,$ChildPart6,$ChildPart7,$ChildPart8,$ChildPart9,$ChildPart10,$ChildPart11,$ChildPart12);
		foreach($array as $childpn)
		{
			$checkchildren = "SELECT PartNumber FROM tblchildparts WHERE PartNumber = '$childpn'";
			$rescheckchildren = mysql_query($checkchildren) or die (mysql_error());
			$children = mysql_num_rows($rescheckchildren);
		}
		if($children == 0)
		{
?>
			...
			<tr>
				<td>
					One or more parts are not a valid part.	
				</td>
			</tr>		
			</table>	
<?php			
	...
	<table width = "500">
		...
		<tr>
			<td>
 			...
 			<td>
 				<input type="submit" value="Cancel" name="childpart">
 			</td>
 		</tr>				
	</table>
	</form>
...
if((isset($_GET['childpartnumber'])) AND (!isset($_GET['savechild'])) AND (isset($_GET['continue'])))
{
 	...
 	<table width = "550" align = "center">	
		<tr>
			...
			<td>
 				 <?php echo $pn; ?>
 				 <?php echo	'<input type = "hidden" name="update" value="child">'; ?>
 				 <?php echo	'<input type = "hidden" name="childpartnumber" value = "'.$pn.'">';?>
 			</td>
 		</tr>
 		<tr>
 			<td>
...
{	
	$childprice = $_GET['lprice'];
	$childqty = $_GET['qty'];
	$description = $_GET['description'];
	$pn = $_GET['childpartnumber'];
	$updatechild = "UPDATE tblchildparts SET Description = '$description', Quantity = '$childqty', ListPrice = '$childprice' WHERE PartNumber = '$pn'";
	mysql_query($updatechild) or die(mysql_error());
?>
	<form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
	<table width = "650" align = "center">
		<tr>
 	...
 	<table width = "550" align = "center">	
		...
		<tr>
			<td>
 				<?php echo '<a href="' . 'pricelist.php'.'">' ?>Back to Parts List
 			</td>
 			<td>
 				<?php echo '<a href="' . 'pricelist.php'.'?update=child'.'">'?>Edit Another Part
 			</td>
 		</tr>				
	</table>
	</form>
...
if((isset($_GET['childpart'])) && ($_GET['childpart'] == "Cancel"))
{
	header("Location: pricelist.php");
}
if((isset($_GET['update'])) && ($_GET['update'] == "add"))
{
?>
<form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
	<table width = "550" align = "center">
		<tr>
			<td><font = "000000" size = "4">
				Add a new part
			</td>
		</tr>
	</table>
	<table width = "550" align = "center">
		<tr>
			...
			<td>
				<input type="text" size="15" maxlength="15" name="pn">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" size="70" maxlength="200" name="description">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" size="12" maxlength="8" name="lprice"> Format: 6.00 = six dollars, 1200.00 = one thousand two hundred dollars.
			</td>
		</tr>	
		<tr>
			<td>
			...
			<td>
				<input type="text" size="70" maxlength="200" name="qty">
			</td>
		</tr>			
		<tr>
			<td>
			...
			<select name=family>
<?php
			$getfamily = "Select Family From tblpartslist Group By Family";
			$resgetfamily = mysql_query($getfamily) or die (mysql_error());	
			while($familylist = mysql_fetch_array($resgetfamily))
			{
?>
				<option value="<?php echo $familylist['Family']; ?>"><?php echo $familylist['Family']; ?></option>	
<?php
			}			
?>				
			</select>
		...
		<tr>
			...
			<td>
				<input type="text" size="70" maxlength="200" name="vendor">
			</td>
		</tr>				
	</table>
	<table width = "550" align = "center">
		<tr>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart1" value = "0">
			</font></td>			
		</tr>
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart2" value = "0">
			</font></td>				
		</tr>
		<tr>			
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart3" value = "0">
			</font></td>			
		</tr>
		<tr>			
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart4" value = "0">
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
				Child Part 5:  
						...
						<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart5" value = "0">
			</font></td>
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart6" value = "0">
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart7" value = "0">
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart8" value = "0">
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart9" value = "0">
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart10" value = "0">
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart11" value = "0">
			</font></td>				
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<input type="text" size="15" maxlength="15" name="ChildPart12" value = "0">
			</font></td>			
		</tr>				
		<tr>
			<td>
 				<input type="submit" value="Save" name="savenewpart">
 			</td>
 		</tr>
 	</table>		
</form>					
...
if((isset($_GET['savenewpart'])) && ($_GET['savenewpart'] == "Save"))
{
	$pn = $_GET['pn'];
	$description = $_GET['description'];
	$lprice = $_GET['lprice'];
...
<form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
	<table width = "550" align = "center">
		<tr>
			...
			<td>
				<?php echo $pn; ?>
				<?php echo	'<input type = "hidden" name="pn" value = "'.$pn.'">';?>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<?php echo $description; ?>
				<?php echo	'<input type = "hidden" name="description" value = "'.$description.'">';?>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<?php echo $lprice; ?>
				<?php echo	'<input type = "hidden" name="lprice" value = "'.$lprice.'">';?>
			</td>
		</tr>		
		<tr>
			<td>
			...
			<td>
				<?php echo $qty; ?>
				<?php echo	'<input type = "hidden" name="qty" value = "'.$qty.'">';?>
			</td>
		</tr>		
		<tr>
			<td>
			...
			<td>
				<?php echo $family; ?>
				<?php echo	'<input type = "hidden" name="family" value = "'.$family.'">';?>
			</td>
		</tr>		
		<tr>
			<td>
			...
			<td>
				<?php echo $vendor; ?>
				<?php echo	'<input type = "hidden" name="vendor" value = "'.$vendor.'">';?>
			</td>
		</tr>						
	</table>
	<table width = "550" align = "center">
		<tr>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart1; ?>
				<?php echo	'<input type = "hidden" name="ChildPart1" value = "'.$ChildPart1.'">';?>
			</font></td>			
		</tr>
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart2; ?>
				<?php echo	'<input type = "hidden" name="ChildPart2" value = "'.$ChildPart2.'">';?>
			</font></td>				
		</tr>
		<tr>			
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart3; ?>
				<?php echo	'<input type = "hidden" name="ChildPart3" value = "'.$ChildPart3.'">';?>
			</font></td>			
		</tr>
		<tr>			
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart4; ?>
				<?php echo	'<input type = "hidden" name="ChildPart4" value = "'.$ChildPart4.'">';?>
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart5; ?>
				<?php echo	'<input type = "hidden" name="ChildPart5" value = "'.$ChildPart5.'">';?>
			</font></td>
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart6; ?>
				<?php echo	'<input type = "hidden" name="ChildPart6" value = "'.$ChildPart6.'">';?>
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart7; ?>
				<?php echo	'<input type = "hidden" name="ChildPart7" value = "'.$ChildPart7.'">';?>
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart8; ?>
				<?php echo	'<input type = "hidden" name="ChildPart8" value = "'.$ChildPart8.'">';?>
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart9; ?>
				<?php echo	'<input type = "hidden" name="ChildPart9" value = "'.$ChildPart9.'">';?>
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart10; ?>
				<?php echo	'<input type = "hidden" name="ChildPart10" value = "'.$ChildPart10.'">';?>
			</font></td>			
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart11; ?>
				<?php echo	'<input type = "hidden" name="ChildPart11" value = "'.$ChildPart11.'">';?>
			</font></td>				
		</tr>			
		<tr>
			<td><font face = Arial size = 2>
			...
			<td><font face = Arial size = 2>
				<?php echo $ChildPart12; ?>
				<?php echo	'<input type = "hidden" name="ChildPart12" value = "'.$ChildPart12.'">';?>
			</font></td>			
		</tr>		
		<tr>
			<td colspan = "4">
	...
	<table width = "550" align = "center">		
		<tr>
			<td>
				Add Part as Child with the properties as a child part.
			</td>
		</tr>	
		<tr>
			<td>
			...
			<td>
				<input type="text" size="70" maxlength="200" name="childlprice">
			</td>
		</tr>		
		<tr>
			<td>
				As Child Part Quantity:
			</td>
			<td>
				<input type="text" size="6" maxlength="6" name="childqty">
			</td>
		</tr>							
		<tr>
			<td>
 				<input type="submit" value="Save" name="savefinal">
 			</td>
 		</tr>
 	</table>			
</form>
...
if((isset($_GET['savefinal'])) && ($_GET['savefinal'] == "Save"))
{
	$pn = $_GET['pn'];
	$description = $_GET['description'];
	$lprice = $_GET['lprice'];
	...
	$ChildPart11 = $_GET['ChildPart11'];
	$ChildPart12 = $_GET['ChildPart12'];
	$childlprice = $_GET['childlprice'];
	$childqty = $_GET['childqty'];
	$insertnewpart = "INSERT INTO tblpartslist (PartNumber, Description, Family, VendorName, ListPrice, Quantity, ChildPart1, ChildPart2, ChildPart3,
										ChildPart4, ChildPart5, ChildPart6, ChildPart7, ChildPart8, ChildPart9, ChildPart10, ChildPart11, ChildPart12) VALUES ('$pn',
										'$description', '$family','$vendor','$lprice', '$qty', '$ChildPart1', '$ChildPart2', '$ChildPart3', '$ChildPart4', '$ChildPart5',
										'$ChildPart6', '$ChildPart7', '$ChildPart8', '$ChildPart9', '$ChildPart10', '$ChildPart11', '$ChildPart12')";
										mysql_query($insertnewpart) or die(mysql_error());
	$insertnewchildpart = "INSERT INTO tblchildparts (PartNumber, Description,Family,VendorName,ListPrice,Quantity) VALUES ('$pn',
												'$description', '$family', '$vendor','$childlprice', '$childqty')";									
										mysql_query($insertnewchildpart) or die(mysql_error());
	//header("Location: pricelist.php");
?>
	<table width = "550" align = "center">
		<tr>
			<td>
				Part Number Added Successfully
			</td>
		</tr>
		<tr>
			<td>
				<?php echo '<a href="' . 'pricelist.php'.'">'?>Back to Pricelist	
			</td>
		</tr>		
<?php
}
