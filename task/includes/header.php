				...
				<tr>
					<td valign="bottom">
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
						  		<td><a href="/csp/"><img src="/csPortal/images/Home_ButtonOff.gif" border="0" onmouseover="this.src='/csPortal/images/Home_ButtonOver.gif'" onmouseout="this.src='/csPortal/images/Home_ButtonOff.gif'";" height="36" alt="Click to go to Netcom homepage."></a></td>
