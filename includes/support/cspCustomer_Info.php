...
<div class="cspDashModule">
	<table class="cspDashRow" cellspacing="0" cellpadding="0" border="0">
		...
		if((!is_null($rowCustInfo1['corpID'])) && ($rowCustInfo1['corpID'] != "")) {
			...
			<tr>
				<td>
					<div><span style="display:inline-block; width:35%; vertical-align:top; text-align:right; padding:1px;">Corporate:</span><span style="display:inline-block; width:62%; vertical-align:top; float:right; padding:1px 1px 1px 5px"><?php echo $rowCustInfo2['name']; ?></span></div>
				</td>
			</tr>
			<?php
		}
