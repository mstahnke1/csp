					...
					<td valign="bottom">
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
						  		...
						  		<td><a href="../csPortal_Sales.php"><img src="../ver2/images/Sales_ButtonActive.gif" border="0" onmouseover="this.src='../ver2/images/Sales_ButtonOver.gif'" onmouseout="this.src='../ver2/images/Sales_ButtonActive.gif'";" height="36" alt="Click to go to Sales homepage."></a></td>
						  		<td><a href="../csPortal_Support.php"><img src="../ver2/images/Support_ButtonOff.gif" border="0" onmouseover="this.src='../ver2/images/Support_ButtonOver.gif'" onmouseout="this.src='../ver2/images/Support_ButtonOff.gif'";" height="36" alt="Click for customer support options."></a></td>								
						  		<?php
						  		if($_SESSION['access'] >= 7) {
									echo "<td><a href=\"csAdmin_Main.php\"><img src=\"../ver2/images/csAdmin_ButtonOff.gif\" border=\"0\" onmouseover=\"this.src='../images/csAdmin_ButtonOver.gif'\" onmouseout=\"this.src='../images/csAdmin_ButtonOff.gif'\";\" height=\"36\" alt=\"HF's company administration portal.\"></a></td>";
									}
									?>
							</tr>
						</table>
