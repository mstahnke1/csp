	...
	<form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
		...
		<table width = "750" align = "center" border = "1">		
			...
			<tr>
				...
				<td align = "center">
					<input type="radio" name="sales_knowledge" value="5">
				</td>				
			</tr>			
			<tr>
				<td>
				...
				<td align = "center">
					<input type="radio" name="sales_ease_of_info" value="5">
				</td>		
			</tr>		
			<tr>
				<td>
				...
				<td align = "center">
					<input type="radio" name="sales_useful_info" value="5">
				</td>			
			</tr>	
			<tr>
				<td>
				...
				<td align = "center">
					<input type="radio" name="sales_professional_manor" value="5">
				</td>		
			</tr>	
		</table>		
		<table width = "750" align = "center" border = "0">
		...
		<table width = "750" align = "center" border = "1">		
			...
			<tr>
				...
				<td align = "center">
					<input type="radio" name="installation_clarity" value="5">
				</td>				
			</tr>			
			<tr>
				<td>
				...
				<td align = "center">
					<input type="radio" name="installation_terms" value="5">
				</td>		
			</tr>		
			<tr>
				<td>
				...
				<td align = "center">
					<input type="radio" name="installation_timely" value="5">
				</td>			
			</tr>	
			<tr>
				<td>
				...
				<td align = "center">
					<input type="radio" name="installation_satisfaction" value="5">
				</td>		
			</tr>	
		</table>		
		<table width = "750" align = "center" border = "0">
...
?>
				...
				<td align = "center">
<?php				
				if($row5['sales_professional_manor'] == 5)
				{
?>					
					<img src="../images/check4.jpg" border="0" width="15" height="15" alt="CHECK">
<?php					
...
?>
				...
				<td align = "center">
<?php				
				if($row5['installation_clarity'] == 5)
				{
?>					
					<img src="../images/check4.jpg" border="0" width="15" height="15" alt="CHECK">
<?php					
...
?>
				...
				<td align = "center">
<?php				
				if($row5['installation_satisfaction'] == 5)
				{
?>					
					<img src="../images/check4.jpg" border="0" width="15" height="15" alt="CHECK">
<?php					
