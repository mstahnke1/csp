...
<table cellspacing="0" cellpadding="0" border="0" width="759" align="center">
		...
		<td>
			<table cellspacing="0" cellpadding="0" border="0" width="600" align="left">
				<tr>
					...
					<a href="index.php"><img src="../ver2/images/logo_home.gif" border="0" width="329" height="65" alt="HomeFree Systems"></a></td>
					<td>
				...
				<tr>
					<td valign="bottom">
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
						  		<td><a href="../"><img src="../ver2/images/Home_ButtonOff.gif" border="0" onmouseover="this.src='../ver2/images/Home_ButtonOver.gif'" onmouseout="this.src='../ver2/images/Home_ButtonOff.gif'";" height="36" alt="Click to go to HF homepage."></a></td>
						  		<td><a href="../ver2/csPortal_Sales.php"><img src="../ver2/images/Sales_ButtonActive.gif" border="0" onmouseover="this.src='../ver2/images/Sales_ButtonOver.gif'" onmouseout="this.src='../ver2/images/Sales_ButtonActive.gif'";" height="36" alt="Click to go to Sales homepage."></a></td>
						  		<td><a href="../ver2/csPortal_Support.php"><img src="../ver2/images/Support_ButtonOff.gif" border="0" onmouseover="this.src='../ver2/images/Support_ButtonOver.gif'" onmouseout="this.src='../ver2/images/Support_ButtonOff.gif'";" height="36" alt="Click for customer support options."></a></td>								
						  		<?php
						  		if($_SESSION['access'] >= 7) {
									echo "<td><a href=\"csAdmin_Main.php\"><img src=\"../ver2/images/csAdmin_ButtonOff.gif\" border=\"0\" onmouseover=\"this.src='../ver2/images/csAdmin_ButtonOver.gif'\" onmouseout=\"this.src='../ver2/images/csAdmin_ButtonOff.gif'\";\" height=\"36\" alt=\"HF's company administration portal.\"></a></td>";
									}
									?>
							</tr>
						</table>
	...
	<tr>
		<td colspan="2">
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>
					<td><img src="../ver2/images/subnav-left.gif" border="0" width="8" height="28" alt=""></td>
					<td width="100%" style="background-image: url(../ver2/images/subnav-bg.gif);">
